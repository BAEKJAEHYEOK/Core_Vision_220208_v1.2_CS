...
namespace Core.UI
{
    public partial class CMainFrame : Form
    {
        ...
        private void CreateForms()
        {
            ...
            MainFormArray[(int)EFormType.SETTING] = new FormManualScreen();
            MainFormArray[(int)EFormType.PARAM] = new FormDataScreen();
            MainFormArray[(int)EFormType.TEACH] = new FormTeachScreen();
            MainFormArray[(int)EFormType.HISTORY] = new FormLogScreen();
