...
namespace Core.Layers
{
    ...
    public class DEF_UI
    {
        ...
        public static readonly int FORM_SIZE_WIDTH = 1925; // Main Frame은 약간 크게 (크지 않으면 스크롤바가 생김)
        public static readonly int FORM_SIZE_HEIGHT = 1085;
        ...
        public static readonly int TOP_SIZE_HEIGHT = 130; //75 

        // Main Screen Forms
        public static readonly int MAIN_POS_X = 0;
        public static readonly int MAIN_POS_Y = 130; // SelectFormChange 메서드에서 Top Screen 위치에 따라 재 조정 됨 
        public static readonly int MAIN_SIZE_WIDTH = 1720; //1920;
        public static readonly int MAIN_SIZE_HEIGHT = 950; //880

        // Bottom Screen Form
        public static readonly int BOT_POS_X = 1720; //0;
        public static readonly int BOT_POS_Y = 130; //980; 
